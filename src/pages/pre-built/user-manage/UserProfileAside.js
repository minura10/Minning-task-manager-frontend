...
const UserProfileAside = ({ updateSm, sm, data }) => {
  useEffect(() => {
    sm
    ...
    <div className="card-inner-group">
      <div className="card-inner">
        <div className="user-card">
          <UserAvatar text={findUpper(data?.user.username)} theme="primary" />
          <div className="user-info">
            <span className="lead-text">{data?.user.username}</span>
            <span className="sub-text">{data?.user.email}</span>
          </div>
